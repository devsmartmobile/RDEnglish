...
-(void)hightLightTextlabel
{
    ...
    self.font = [UIFont systemFontOfSize:([RDConstant sharedRDConstant].fontSizeView + 6)];
    CGSize sizeZoom = [self.text sizeWithAttributes:@{ NSFontAttributeName : [UIFont fontWithName:[UtilsXML utilXMLInstance].fontNames[0] size:[RDConstant sharedRDConstant].fontSizeView + 6] }];
